...
# Replace the above with the appropriate calls to boastUtils::psuPalette in the
# location where you need to call the color. Then you may delete both lines 21-25
        ...
        tabItem(
          ...
          fluidRow(
            column(
              ...
              wellPanel(
                ...
                bsPopover(
                  ...
                  ## Possible Error ----
                  content = paste(
                    "By clicking on this button, 50 new samples each consisting of",
                    #input$nsamp,
              ...
              bsPopover(
                ...
                content = paste("This is the histogram plot of the sample you",
                                "selected on Confidence Interval Plot. The green",
                                " line is the true mean of the population and ",
                                "the black line is the mean of the sample."),
                trigger = "hover",
                placement = "top"
              )
            ),
            column(
              ...
              ### This is NOT the appropriate why to do this. ----
  ...
  output$CoverageRate <- renderText({
    validate(
      need(is.numeric(input$nsamp),
           message = "Please input samle size") #FIX--EVERYWHERE
    )
