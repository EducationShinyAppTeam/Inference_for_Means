              ...
              dashboardBody(tags$head(
                ...
                tabItems(
                  ...
                  tabItem(tabName = "over",
                          ...
                          h4(tags$li("Move the sample size and level sliders to see how they affect confidence intervals for the mean SAT math scores or two-sample tests for differences in SAT writing scores.")),
